...
/*
    command tsc --init will generate a tsconfig file
...
//Essentially it is like JS all over again so why
...
//Usually porting code form Javascript will make all the variable any as you figure so if you know that a value will be a number, string, etc.
//Using Assertion is like casting in C# we are converting the any type into a number type
let a2: any = 10;
let shouldBeNum = <number> a2;

//NUMBER
let n1:number = 5;

//You can give multiple types to a variable using the | inbetween the types
//This is called a Union Type since we are combining two datatypes as a possiblity
...
class SuperVillain {
    ...
    aWayToDoOverloading(p_test:string = "")
    {
