...
namespace RRWebApi.Controllers
{
    ...
    public class RestaurantController : ControllerBase
    {
        ...
        {
            //Ok method will give a status code (if the server was able to process the request)
        ...
        {
            //Create method will give a status code if the server was able to create the data
